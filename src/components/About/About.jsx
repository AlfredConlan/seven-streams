      ...
      <Drawer className="about-template" isOpen={this.state.menuOpen}>
        ...
        <div className="about-content">
          ...
          <p>
            ...
            cultivating zen gardens and sustainably constructed architecture in
            three seasonal locations. Taos, NM (Summer), Sedona, AZ (Spring and
            Fall) and Joshua Tree, CA (Winter) are the desired locations for the
            retreat centers.{" "}
          </p>
          <p>
            ...
            <li>
              ...
              person<ul>
                <li>
                  ...
                  volunteer work, along with contributing monetarily to the
